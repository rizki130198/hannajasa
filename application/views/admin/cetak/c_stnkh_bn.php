						...
						<div class="card-content">
							<form action="" class="form-horizontal">
										...
										<div class="media">
											...
											<div class="media-body" style="padding-left: 20px;">
												...
												<div class="form-group row" style="margin-top: -12px !important;">
													...
													<div class="col-sm-8">
														<input type="text" value="<?=$stnkhilang->penerima?>" style="margin-top: -3px;" class="form-control" placeholder="Masukan nama">
													</div>
													<label class="col-sm-4 col-form-label" style="padding-left: 0;width: 27%;margin-top: -10px;">Telp./HP <span class="titik2">:</span></label>
													<div class="col-sm-8">
														<input type="number" value="<?=$stnkhilang->no_telp?>" style="margin-top: -10px;" class="form-control" placeholder="Masukan nomor telp/hp">
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-md-12" style="">
									<h4 style="font-weight: bold;text-align: right;margin-top: -10px;margin-bottom: 0 !important;">No : <span style="text-decoration: underline;padding-bottom: 0 !important;"><?=$stnkhilang->no?></span></h4>
								</div>
								<div class="form-group row" style="margin-top:-10px !important;margin: 0 !important;">
									...
									<div class="col-sm-8">
										<div class="input-group">
											...
											<input type="text" value="<?=$stnkhilang->atas_nama?>" style="margin-top: -3px;" class="form-control" placeholder="Sudah terima dari ( atas nama )">
										</div>
									</div>
								</div>
								<div class="form-group row" style="margin: 0 !important;">
									...
									<div class="col-sm-8">
										<div class="uangmuka"><h5 style="transform: skew(25deg);margin: 0 10px;">Rp. <?=$stnkhilang->uang_dp?></h5></div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4 berkas" style="display: inline-flex;">
										<?php $bpkb = explode(',', $stnkhilang->bpkb);?>
										<?php $sim = explode(',', $stnkhilang->sim);?>
										<?php $rowstnk = explode(',', $stnkhilang->stnk);?>
										<?php $pengurusan = explode(',', $stnkhilang->pengurusan);?>
									...
									<div class="col-sm-3">
										<div class="input-group" style="margin-top:-35px !important;">
											...
											<input type="text" value="<?=$stnkhilang->nopol?>" class="form-control" placeholder="Masukan Nopol">
										</div>
									</div>
									<div class="col-md-1">
										<div class="input-group" style="margin-top:-35px !important;">
											<select class="form-control" name="jenis_k" required="">
												...
												<option value="" selected><?=$stnkhilang->jenis_kendaraan?></option>
											</select>
								...
								<div class="form-group row">
									...
									<div class="col-sm-5">
										<div class="input-group" style="margin-top:-35px !important;">
											...
											<input type="text" value="<?=$stnkhilang->wilayah?>" class="form-control" placeholder="Masukan Wilayah">
										</div>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-md-5">
										<div class="input-group" style="margin-top:-35px !important;">
											...
											<input type="text" value="<?=$stnkhilang->tahun_pajak?>" class="form-control" placeholder="Masukan Masa Berlaku">
										</div>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" value="<?=$stnkhilang->lainnya?>" style="margin-top:-35px !important;" class="form-control">
									</div>
								</div>
								<div class="form-group row" style="margin: 0 !important;">
													...
													<tr>
															...
															<div class="form-group row" style="margin-top:0px !important;">
																<div class="col-sm-12" style="display: inline-flex;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->pajak_ini==NULL)?NULL :'checked value="'.$stnkhilang->pajak_ini.'"'?>> Pajak Tahun ini</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		...
																		<input type="text" value="<?=$stnkhilang->harga_pajak_ini?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0px !important;">
																<div class="col-sm-12" style="display: inline-flex;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->pajak_lalu==NULL)?NULL :'checked value="'.$stnkhilang->pajak_lalu.'"'?>> Pajak Tahun lalu (SKP)</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_pajak_lalu?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;">
																	...
																	<div class="input-group" style="width: 50%;margin-top: -4px;border-top: solid 1.5px #333;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->total_cpajak?>" class="form-control">
																	</div>
																</div>
															</div>
														...
														<td style="vertical-align: top;">
															<div class="form-group row" style="margin-top:0px !important;">
																<div class="col-sm-12" style="display: inline-flex;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->proses_sh==NULL)?NULL :'checked value="'.$stnkhilang->proses_sh.'"'?>> Biaya Proses STNK Hilang</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_sh?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top:0px !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->proses_bn==NULL)?NULL :'checked value="'.$stnkhilang->proses_bn.'"'?>> Biaya Proses BN/PA</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_bn?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->adm_skp==NULL)?NULL :'checked value="'.$stnkhilang->adm_skp.'"'?>> Adm. SKP/Pajak Lalu</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_adm?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->surat_lp==NULL)?NULL :'checked value="'.$stnkhilang->surat_lp.'"'?>> Surat Laporan Kepolisian</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_lp?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->plat==NULL)?NULL :'checked value="'.$stnkhilang->plat.'"'?>> + Ganti Plat</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_plat?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox" <?=($stnkhilang->balik_nama==NULL)?NULL :'checked value="'.$stnkhilang->balik_nama.'"'?>> + Balik Nama/Ganti BPKB</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_balik?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	...
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_pa?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="width: 50%;margin-left: 0;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->psl==NULL)?NULL :'checked value="'.$stnkhilang->psl.'"'?>> Pembuatan Surat Leasing</label>
																	</div>
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_psl?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="margin-left: 0;padding-right: 28px;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox" <?=($stnkhilang->p_lainnya==NULL)?NULL :'checked value="'.$stnkhilang->p_lainnya.'"'?>></label>
																	</div>
																	<input type="text" style="width: 44%;margin-top: -4px;" value="<?=$stnkhilang->p_lainnya?>" class="form-control" placeholder="">
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->h_lainnya?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																<div class="col-sm-12" style="display: inline-flex;margin-top:-10px;">
																	<div class="checkbox" style="margin-left: 0;padding-right: 28px;">
																		<label style="font-weight: bold;color: #333;"><input type="checkbox"<?=($stnkhilang->proses_lain==NULL)?NULL :'checked value="'.$stnkhilang->proses_lain.'"'?>></label>
																	</div>
																	<input type="text" style="width: 44%;margin-top: -4px;" value="<?=$stnkhilang->proses_lain?>" class="form-control" placeholder="">
																	<div class="input-group" style="margin-top: -6px;width: 50%;float: right;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">: Rp.</span>
																		<input type="text" value="<?=$stnkhilang->harga_lainnya?>" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
															...
															<div class="form-group row" style="margin:0 !important;">
																...
																<div class="col-sm-6">
																	<div class="input-group" style="margin-top: -10px !important;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">Rp.</span>
																		<input value="<?=$stnkhilang->biaya_prediksi?>" type="text" style="background-image: linear-gradient(#9c27b0, #9c27b0), linear-gradient(#333, #333);" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group row" style="margin-top: 0 !important;">
																...
																<div class="col-sm-6">
																	<div class="input-group" style="margin-top: -15px !important;">
																		<span class="input-group-addon" style="font-weight: bold;color: #333;">Rp.</span>
																		<input type="text" value="<?=$stnkhilang->biaya_kurang?>" style="background-image: linear-gradient(#9c27b0, #9c27b0), linear-gradient(#333, #333);" class="form-control">
																	</div>
																</div>
															</div>
														</td>
